                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						You Receive This Email For Reset your Login Password
                                ...
                                <tr><td align="center">
                                        <div style="line-height: 24px;">
                                            <a style='background:green;padding: 5px 10px;text-decoration:none;border-radius:3px;color:#fff;font-weight:bold' href="<?php echo e($link); ?>" target="_blank" class="btn btn-danger block-center">
                                                Reset Password
                                            </a>
                                        </div>
                                        <!-- padding --><div style="height: 60px; line-height: 60px; font-size: 10px;"></div>
