        	...
        	<div class="row">
                ...
                <div class="col-md-4">
                    <div class="pricing_info">
                        <p class="listing_price"><span><del>deR$ </del></span><del><?php echo e(round($data->min_price)); ?></del> - <span>porR$</span> <?php echo e(round($data->max_price)); ?></p>
                                            ...
                                            <div class="post_img">
                                                ...
                                                <div class="text-center selo">
                                                    <div class="selo-content">
                                                        <span class="selo-text"><?php echo e(abs(round(100 - ($da->max_price* 100) / $da->min_price))); ?>%</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="post_info">
