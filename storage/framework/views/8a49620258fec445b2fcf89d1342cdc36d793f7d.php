...
<?php $__env->startSection('content'); ?>	
    ...
    <?php echo $__env->make('errors.errors', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="box box-info">
            ...
            <form action="<?php echo e(url('/search_bg')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>


            <div class="box-body">
                <input type="hidden" name="id" value="<?php echo e($Background->id); ?>">
                ...
                <div class="form-group">
                  ...
                  <?php if($Background->search_bg == null): ?>
                  <h5 style="color: red; text-align: center;">there is no Image</h5>
                  <?php else: ?>
                  <img src="<?php echo e(asset('public/images/'.$Background->search_bg)); ?>" height="120px" width="280px">
                  <?php endif; ?>
                </div>
            </div>
            <!-- /.box-body -->
    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/testimonial_bg')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"> </label>
                  <?php if($Background->testimonial_bg == null): ?>
                  <h5 style="color: red;text-align: center;">there is no Image</h5>
                  <?php else: ?>
                  <img src="<?php echo e(asset('public/images/'.$Background->testimonial_bg)); ?>" height="120px" width="280px">
                  <?php endif; ?>
                </div>
            </div>
            <!-- /.box-body -->
    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/timer_bg')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"> </label>
                  <?php if($Background->timer_bg == null): ?>
                  <h5 style="color: red;text-align: center;">there is no Image</h5>
                  <?php else: ?>
                  <img src="<?php echo e(asset('public/images/'.$Background->timer_bg)); ?>" height="120px" width="280px">
                  <?php endif; ?>
                </div>
            </div>
            <!-- /.box-body -->
    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/subscriber_bg')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"> </label>
                  <?php if($Background->subscriber_bg == null): ?>
                  <h5 style="color: red;text-align: center;">there is no Image</h5>
                  <?php else: ?>
                  <img src="<?php echo e(asset('public/images/'.$Background->subscriber_bg)); ?>" height="120px" width="280px">
                  <?php endif; ?>
                </div>
            </div>
            <!-- /.box-body -->
    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/about_bg')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"> </label>
                  <?php if($Background->about_bg == null): ?>
                  <h5 style="color: red;text-align: center;">there is no about-us image</h5>
                  <?php else: ?>
                  <img src="<?php echo e(asset('public/images/'.$Background->about_bg)); ?>" height="120px" width="280px">
                  <?php endif; ?>
                </div>
            </div>
            <!-- /.box-body -->
    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/contact_bg')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"> </label>
                  <?php if($Background->contact_bg == null): ?>
                  <h5 style="color: red;text-align: center;">there is no Contact-us Image</h5>
                  <?php else: ?>
                  <img src="<?php echo e(asset('public/images/'.$Background->contact_bg)); ?>" height="120px" width="280px">
                  <?php endif; ?>
                </div>
            </div>
            <!-- /.box-body -->
