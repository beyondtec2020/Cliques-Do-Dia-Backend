...
<!-- Titlebar -->
    ...
    line-height: 30px;
    width: auto;
    padding: 8px 22px;"> <i class="fa fa-arrow-left"></i> Back</a>
    ...
    <div class="row">			
        <div class="col-md-12">
             ...
             <b>Title: </b> <p><?php echo e($AddList->title); ?></p>
             </div>
        </div>
        <div class="col-md-12">
             <div class="add_listing_info">
             <b>Short Description : </b> <p><?php echo e($AddList->short_desc); ?></p>
             </div>
        </div>
        ...
        <div class="col-md-12">
             ...
             <b>Category : </b> <p><?php echo e($AddList->cat->name); ?></p>
             </div>
             <div class="add_listing_info col-md-1">
             <b>City :</b> <p><?php echo e($AddList->city->name); ?></p>
             </div>
             <div class="add_listing_info col-md-2">
             <b>Zip Code :</b> <p><?php echo e($AddList->zip_code); ?></p>
             </div>
        </div>
        
        <div class="col-md-12">
             <div class="add_listing_info col-md-2">
             <b>Address :</b> <p><?php echo e($AddList->address); ?></p>
             </div>
             <div class="add_listing_info col-md-3">
             <b>Phone :</b> <p><?php echo e($AddList->phone); ?></p>
             </div>
        </div>
        
        <div class="col-md-12">
             <div class="add_listing_info">
             <b style="float: none;">Address :</b> <p style="margin-top: 5px;"><?php echo e($AddList->description); ?></p>
             </div>
        </div>

        <div class="col-md-12">
             <div class="add_listing_info col-md-2" >
             <b>Max Price :</b> <p><?php echo e($AddList->max_price); ?> </p>
             </div>

             <div class="add_listing_info col-md-3">
             <b>Min Price :</b> <p><?php echo e($AddList->min_price); ?> </p>
             </div>
        </div>
