...
<style type="text/css"> 
.style2_header {
    /*background-image:url(<?php echo e(asset('public/assets/images/listing_img2.jpg')); ?>);*/
        	...
        	<div class="row">
            	<div class="col-md-8">
                    ...
                    <div class="listing_rating">
                        ...
                        ?> <?php echo e(number_format( $totalRating,1)); ?>/5</span> 
                                            ...
                                            <?php switch(number_format( $totalRating,0)):
                                                ...
                                                <?php default: ?>
                                                    ...
                                                    <i class="fa fa-star"></i>
                                            <?php endswitch; ?>
                           (<?php echo e($data->review()->count('id')); ?> Reviews) </p>
                        ...
                        <input type="hidden" name="postId" value="<?php echo e($data->id); ?>">
                            ...
                            <?php endif; ?>
                        <button type="submit" class="" style="background: transparent;border: transparent;"><i class="fa fa-bookmark-o"></i> Add to favorites</button>
                        </p>
                        </form>
                ...
                <div class="col-md-4">
                	<div class="pricing_info">
                        <p class="listing_price"><span>$</span><?php echo e($data->min_price); ?> - <span>$</span><?php echo e($data->max_price); ?></p>
	...
	<div class="container">
        	<div class="sidebar_wrap listing_action_btn">
                <ul>
                    ...
                    <?php if(!$checkReport): ?>
                    <li><a data-toggle="modal" data-target="#report_modal" bootstrap-modal-form-open><i class="fa fa-exclamation-triangle"></i> Report</a></li>
                    <?php endif; ?>
                    <?php else: ?>
                    <li><a data-toggle="modal" data-target="#report_modal_login" bootstrap-modal-form-open><i class="fa fa-exclamation-triangle"></i> Report</a></li>
                    <?php endif; ?>
                </ul>
            </div>
            ...
            <div class="image_slider_wrap">
                ...
                <div class="section-padding  ">
                    ...
                    <div class="listinghub_detail">
                                  ...
                                  <div class="panel-body">
                                    <ul>
                                     ...
                                     <?php   $v = \App\Amenity::where('id',$d->amenities_id)->first(); ?>
                                            <?php if($v != null): ?><li><a href="#" > <i class="fa fa-check-square"></i> <?php echo e($v->name); ?> </a></li><?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="reviews_list">
                            ...
                            <?php if($count != 0): ?>
                            <div class="widget_title">
                                <h4><span> <?php echo e($count); ?>  Reviews </span></h4>
                            </div>
                             <?php endif; ?>
                            ...
                            <div class="review_wrap">
                                ...
                                <div class="review_detail">
                                    ...
                                    <div class="listing_rating">
                                        ...
                                        <p><i class="fa fa-clock-o"></i> <?php echo e($v->created_at->toDayDateTimeString()); ?></p>  
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php  $checkData = App\Review::where('user_id', Sentinel::getUser()->id)->where('addlist_id',$data->id)->first(); ?>
                    	...
                    	<div class="widget_title">
    						...
    						<form action="<?php echo e(url('/review-post')); ?>" method="post" data-toggle="validator" id="reviewForm">
                            <?php echo e(csrf_field()); ?>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="#" class="active" id="login-form-link">Please Sign In for write a review</a>
                            </div>
                        </div>
                        <hr>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="login-form" action="<?php echo e(url('/login-review')); ?>" method="post" role="form" style="display: block;" enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-3"><a href="<?php echo e(url('/forgot-password')); ?>" tabindex="5" class="forgot-password">Forgot Password?</a>
                                            </div>
                                            <div class="col-lg-6">Don't have an account?
                                                    <a href="<?php echo e(url('/register')); ?>" tabindex="5" class="forgot-password"> Signup Here</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="listinghub_sidebar">
                        <div class="sidebar_wrap listing_contact_info">
                            ...
                            <ul>
                                ...
                                <li><i class="fa fa-envelope"></i> <a href="mailto:<?php echo e($data->email); ?>"><?php echo e($data->email); ?></a></li><?php endif; ?>

                                <?php if($data->website != null): ?>
                                <li><i class="fa fa-link"></i> <a href="<?php echo e($data->website); ?>" target="_blank"><?php echo e($data->website); ?></a></li><?php endif; ?>
                            </ul>
                            <div class="social_links">
                            <?php if($data->facebook != null): ?>
                                <a href="<?php echo e($data->facebook); ?>" class="facebook_link" target="_blank"><i class="fa fa-facebook-f"></i></a>
                            <?php endif; ?>
                            <?php if($data->linkdin != null): ?>
                                <a href="<?php echo e($data->linkdin); ?>" class="linkedin_link" target="_blank"><i class="fa fa-linkedin"></i></a>
                            <?php endif; ?>
                            <?php if($data->twitter != null): ?>
                                <a href="<?php echo e($data->twitter); ?>" class="twitter_link" target="_blank"><i class="fa fa-twitter"></i></a>
                            <?php endif; ?>
                            <?php if($data->google != null): ?>
                                <a href="<?php echo e($data->google); ?>" class="google_plus_link" target="_blank"><i class="fa fa-google-plus"></i></a>
                            <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="" style="padding-bottom: 20px;">
                            ...
                            <a href="<?php echo e(url('/click-add/'.$v->id)); ?>" target="_blank"> 
                              ...
                              <img class="img-responsive" src="<?php echo e(asset('public/images/advertise/'.$v->val1)); ?>" alt="" class="img-responsive" />
                              <?php else: ?>
                                  <?php echo $v->val; ?>
                            ...
                            <div id="latest_listing_slider">
                                ...
                                <?php $__currentLoopData = $latest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="listing_wrap">
                                            <div class="listing_img video-list-thumbs">
                                                <a href="<?php echo e(url('/single-post/'.$data->id.'/'.$data->slug)); ?>"><img src="<?php echo e(asset('public/images/'.$data->CountImage()->first()->image)); ?>" alt="">
                                                </a>
                                            </div>
                                            <div class="listing_info">
                                                <h4 class="text-center bold"><a href="<?php echo e(url('/single-post/'.$data->id.'/'.$data->slug)); ?>"><?php echo e($data->title); ?></a></h4>
                                            ...
                                            <?php endswitch; ?>
                                                    ...
                                                    <div class="post_category pull-right">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php echo e(csrf_field()); ?>
          ...
          <div class="form-group">
          	<input type="text" class="form-control" data-error="Please enter name field." name="name" placeholder="Name" required>
            <div class="help-block with-errors"></div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <textarea rows="4" class="form-control" name="message" placeholder="Message" data-error="Please enter message field." required ></textarea>
            <div class="help-block with-errors"></div>
          </div>
          <div class="form-group">
