        	...
        	<div class="row">
                ...
                <div class="col-md-4">
                	<div class="pricing_info">
                        <p class="listing_price"><span>de R$</span><?php echo e($data->min_price); ?> - <span>por R$</span><?php echo e($data->max_price); ?></p>
                                ...
                                <?php $__currentLoopData = $latest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $da): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="listing_wrap">
                                            <div class="listing_img video-list-thumbs">
                                                <a href="<?php echo e(url('/single-post/'.$da->id.'/'.$da->slug)); ?>"><img src="<?php echo e(asset('public/images/'.$da->CountImage()->first()->image)); ?>" alt="">
                                                </a>
                                            </div>
                                            <div class="listing_info">
                                                <h4 class="text-center bold"><a href="<?php echo e(url('/single-post/'.$da->id.'/'.$da->slug)); ?>"><?php echo e($da->title); ?></a></h4>
                                            ...
                                            <?php endswitch; ?>
                                                    ...
                                                    <div class="post_category pull-right">
                                                        <a href="<?php echo e(url('/single-category/'.$da->cat->id.'/'.$da->cat->slug)); ?>"><?php echo e($da->cat->name); ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
