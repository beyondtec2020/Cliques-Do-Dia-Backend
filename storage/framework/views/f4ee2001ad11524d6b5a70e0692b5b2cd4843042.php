                ...
                <?php echo e(csrf_field()); ?>
                    	...
                    	<div class="add_listing_info">
                            ...
                            <div class="form-group <?php echo e($errors->has('title') ? 'has-error' : ''); ?>">
                                    <label class="label-title"> Título da oferta (O título não pode ser maior que 50 caracteres)</label>
                                    <input type="text" name="title" class="form-control">
                                <?php echo $errors->first('title', '<p class="help-block">:message</p>'); ?>

                                </div>
                            <div class="form-group <?php echo e($errors->has('short_description') ? 'has-error' : ''); ?>">
                                <label class="label-title">Resumo da oferta (O resumo não pode ser maior que 80 caracteres)</label>
