...
<section id="inner_banner" class="parallex-bg contactus_bg">
    <div class="container">
        <div class="white-text text-center div_zindex">
            <h1> <i class="fa fa-map-marker"></i> <?php echo e($city->name); ?> </h1>
        </div>
    </div>
...
<section id="" class="section-padding">
	<div class="container">
    	...
    	<div class="row">
    	<?php $__currentLoopData = $dd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
