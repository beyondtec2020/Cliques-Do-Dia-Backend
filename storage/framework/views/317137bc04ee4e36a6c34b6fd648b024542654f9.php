...
<!-- Titlebar -->
		<div id="titlebar">
			<div class="row">
				<div class="col-md-12">
					<h2>Edit-List</h2>
                    <a href="<?php echo e(URL::previous()); ?>" type="button" class="pull-right btn  btn-info btn-flat"><i class="fa fa-arrow-left"></i> <b>Back </b> </a>
				</div>
			</div>
		</div>
        ...
        <div class="row">			
            <div class="col-lg-12 col-md-12">
                ...
                <?php echo e(csrf_field()); ?>
                        ...
                        <div class="add_listing_info">
                            <input type="submit" value="Update Listing" class="btn btn-block">
                        </div>   
                    </form>
			</div>
			</div>
