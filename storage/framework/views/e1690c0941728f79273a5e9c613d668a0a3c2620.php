        	...
        	<div class="row">
                ...
                <div class="col-md-4">
                    <div class="pricing_info">
                        <p class="listing_price"><span><del>deR$ </del></span><del><?php echo e($data->min_price); ?></del> - <span>porR$</span> <?php echo e($data->max_price); ?></p>
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                              ...
                              <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingTwo">
                                  <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#amenities" aria-expanded="false" aria-controls="collapseTwo"><i class="fa fa-align-left"></i> Facilidades</a>
                                  </h4>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-3"><a href="<?php echo e(url('/forgot-password')); ?>" tabindex="5" class="forgot-password">Esqueceu Senha?</a>
                                            </div>
                                            <div class="col-lg-6">Caso não tem uma conta?
                                                    <a href="<?php echo e(url('/register')); ?>" tabindex="5" class="forgot-password"> Cadastre-se</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="listinghub_sidebar">
                            ...
                            <div class="listing_video">
                              <ul>
                                <?php $__currentLoopData = $cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <li><a href="<?php echo e(url('/single-category/'.$dat->id.'/'.$dat->slug)); ?>"><?php echo e($dat->name); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </ul>
                            </div>
                        </div>
                        ...
                        <div class="widget_title">
                                ...
                                <?php $__currentLoopData = $latest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $da): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="post_wrap">
                                            <div class="text-center">
                                                <h6><a href="<?php echo e(url('/single-post/'.$da->id.'/'.$da->slug)); ?>"><?php echo e(str_limit($da->title,25,'..')); ?></a></h6>
                                            </div>
                                            <div class="post_img">
                                                <div class="listing_cate">
                                                    <span class="cate_icon">
                                                        <a href="<?php echo e(url('/single-category/'.$da->cat->id.'/'.$da->cat->slug)); ?>">
                                                        <img src="<?php echo e(asset('public/images/'.$da->cat->cat_image)); ?>" alt="icon-img"></a>
                                                    </span>
                                                </div>
                                                <a href="<?php echo e(url('/single-post/'.$da->id.'/'.$da->slug)); ?>">
                                                    <img src="<?php echo e(asset('public/images/'.$da->CountImage()->first()->image)); ?>" alt="image"></a>
                                                <div class="text-center selo">
                                                    <div class="selo-content">
                                                        <span class="selo-text"><?php echo e(round(100 - ($da->min_price * 100) / $da->max_price)); ?>%</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="post_info">
                            ...
                            <div class="col-sm-6 text-right">
                                <span><del>de:R$<?php echo e($da->min_price); ?></del></span>
                            </div>
                            <div class="col-sm-6 text-left">
                                <span class="">por:R$<?php echo e($da->max_price); ?></span>
                            </div>
                        </div>
                                                <div class="row product-time">
                                                    <div class="col-sm-6 col-sm-offset-6 text-right">
                                                        <a href="<?php echo e(url('/single-post/'.$da->id.'/'.$da->slug)); ?>" class="btn btn-oferta btn-sm text-right">Ver Detalhes</a>
                                                    </div>
                                                </div>
                                                <div class="post_meta">
                                                    ...
                                                    <?php switch(number_format( $totalRating,0)):
                                                        ...
                                                        <i class="fa fa-star"></i>
                                                    <?php endswitch; ?>
                                                    <p class="listing_map_m pull-right"><i class="fa fa-map-marker"></i> <?php echo e($da->city->name); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
