...
<a href="<?php echo e(url('/manage-slider')); ?>" type="button" class="pull-right btn  btn-info btn-flat"><i class="glyphicon glyphicon-arrow-left"></i> <b> Back </b> </a>
</section><br>
      ...
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <div class="col-sm-9 col-sm-offset-2"><?php echo $__env->make('errors.errors', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div>
             ...
             <form action="<?php echo e(url('/add-slider')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
