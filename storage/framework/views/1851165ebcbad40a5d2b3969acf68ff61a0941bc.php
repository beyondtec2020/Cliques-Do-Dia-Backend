        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navigation">
            ...
            <div class="submit_listing">
                <a href="<?php echo e(url('/add-lists-user')); ?>" class="btn outline-btn"><i class="fa  fa-plus-circle"></i> Criar Anúncio</a>
            </div>
            ...
            <?php else: ?>
            <div class="submit_listing">
                <a href="<?php echo e(url('/add-lists')); ?>" class="btn outline-btn"><i class="fa  fa-plus-circle"></i> Criar Anúncio</a>
            </div>
            <?php endif; ?>
