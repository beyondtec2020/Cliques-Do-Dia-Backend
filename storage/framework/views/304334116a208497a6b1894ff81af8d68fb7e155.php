...
<!-- Titlebar -->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="buttons-to-right">
                        <a href="<?php echo e(route('viewUserProfile')); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
				</div>
			</div>
		</div>
	...
	<div class="row">			
		...
		<div class="col-lg-12 col-md-12">
	    	...
	    	<div class="add_listing_info">
                <h6><strong>Update Informations</strong></h6>	
	...
	<div class="row">			
		...
		<div class="col-lg-12 col-md-12">
	    	<div class="add_listing_info">
                <h6><strong>  Change Profile </strong></h6>	
        ...
        <form action="<?php echo e(route('profile')); ?>" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group <?php echo e($errors->has('profile') ? 'has-error' : ''); ?>">
                ...
                <div class="form-group">
                <div class="col-sm-8 col-sm-offset-3">
                <button type="submit" class="btn btn-primary" style="min-width: 365px">Upload Photo  </button></div>
                	</div>
