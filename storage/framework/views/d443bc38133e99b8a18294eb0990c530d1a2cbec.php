...
<div class="dashboard_container">
                    ...
                    <div class="user_nav">
                      ...
                      <img src="<?php echo e(asset('public/images/'.Sentinel::getUser()->profile)); ?>" alt="img"><?php endif; ?>
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dLabel">
                            <li><a href="<?php echo e(url('/user')); ?>"><i class="fa fa-cogs"></i> Dashboard</a></li>
                            <li><a href="<?php echo e(route('viewUserProfile')); ?>"><i class="fa fa-user-o"></i> My Profile</a></li>
                            <li><a href="<?php echo e(route('logout')); ?>"><i class="fa fa-power-off"></i> Logout</a></li>                   
                          </ul>
                        </div>
                    </div>
                    <div class="submit_listing">
                        <a href="<?php echo e(url('/add-lists')); ?>" class="btn outline-btn"><i class="fa  fa-plus-circle"></i> Submit Listing</a>
                     </div>
                </div>
             </div>   
        </nav>
	...
	<div id="dashboard-nav" class="dashboard-nav">	
		<ul>
          ...
          <a href="<?php echo e(url('/user')); ?>"><i class="fa fa-cogs"></i> Dashboard</a></li>
        ...
        <?php $userId = Sentinel::getUser()->id;?>
					<li><a href="<?php echo e(route('activeShowList')); ?>">Active <span class="nav-tag green">
            <?php echo e($AddList->where('user_id',$userId)->where('status',1)->count()); ?></span></a></li>
					<li><a href="<?php echo e(route('pendingList')); ?>">Pending <span class="nav-tag yellow">
            <?php echo e($AddList->where('user_id',$userId)->where('status',0)->count()); ?></span></a></li>
					<li><a href="<?php echo e(route('expiredList')); ?>">Expired <span class="nav-tag red">
      ...
      <a href="<?php echo e(url('/review-lists')); ?>"><i class="fa fa-star-o"></i> Reviews</a></li>

			<li class="<?php echo e(url()->current() == url('/bookmarks')?'active':''); ?>">
      <a href="<?php echo e(url('/bookmarks')); ?>"><i class="fa fa-bookmark-o"></i> Bookmarks</a></li>

			<li class="<?php echo e(url()->current() == url('/add-lists')?'active':''); ?>">
      <a href="<?php echo e(url('/add-lists')); ?>"><i class="fa fa-plus"></i> Add Listing</a></li>

      <li class="<?php echo e(url()->current() == route('viewUserProfile')?'active':''); ?>">
      <a href="<?php echo e(route('viewUserProfile')); ?>"><i class="fa fa-user-o"></i> My Profile</a></li>
			<li><a href="<?php echo e(route('logout')); ?>"><i class="fa fa-power-off"></i> Logout</a></li>
		</ul>	
	</div>
	<!-- Navigation / End -->
