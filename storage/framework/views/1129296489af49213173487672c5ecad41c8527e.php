...
<a href="<?php echo e(url('/city')); ?>" type="button" class="pull-right btn  btn-info btn-flat"><i class="glyphicon glyphicon-arrow-left"></i> <b> Back </b> </a>
</section><br>
      ...
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
             ...
             <form action="<?php echo e(url('/update-city')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data" name="editCategoryForm">
            ...
            <input type="hidden" name="id" value="<?php echo e($city->id); ?>">
                <div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                  <label for="" class="col-sm-2  control-label">
                    Name :</label>
                  <div class="col-sm-9">
                  <input type="text" name="name" class="form-control" placeholder="Name" value="<?php echo e($city->name); ?>" >
      ...
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
             ...
             <form action="<?php echo e(url('/update-cityImage')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
              <?php echo e(csrf_field()); ?>
            ...
            <input type="hidden" name="id" value="<?php echo e($city->id); ?>">
                ...
                <div class="form-group <?php echo e($errors->has('city_image') ? 'has-error' : ''); ?>">
                  <label for="" class="col-sm-2 control-label">
                    Image :</label>
                  <div class="col-sm-9">
                    ...
                    <?php echo $errors->first('city_image', '<p class="help-block">:message</p>'); ?>

                    <br>
                    <img src="<?php echo e(asset('public/images/'.$city->city_image)); ?>">
                  </div>
                </div>
            </div>
            <!-- /.box-body -->
...
<script type="text/javascript">
  document.forms['editCategoryForm'].elements['status'].value=<?php echo e($city->status); ?>
