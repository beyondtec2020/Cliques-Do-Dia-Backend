					...
					<?php $v = $data->CountImage()->first(); ?>
						<li>
							...
							<div class="buttons-to-right">
								...
								<a href="<?php echo e(url('/edit-list/'.$data->id.'/'.$data->slug)); ?>" class="button gray"><i class="fa fa-pencil"></i> Edit</a>
								<?php endif; ?>

								<a href="<?php echo e(url('/delete-list/'.$data->id.'/'.$data->slug)); ?>" onclick="checkDelete()" class="button red"><i class="fa fa-trash-o"></i> Delete</a>
							</div>
						</li>
