...
<section class="content">
      ...
      <div class="col-xs-12 ">
        <div class="box box-info">
            <div class="box-header with-border blue">
              <h3 class="box-title "><i class="fa fa-flag"></i><strong> Reports (<?php echo e($AddList->reports()->count()); ?>)</strong></h3>
      ...
      <div class="row" > 
        ...
        <h4>Report Type :
            ...
            <b>Duplicate Listing</b>
            <?php elseif($data->report_type == 2): ?>
            <b>Wrong Contact Info</b>
            ...
            <p class="text-muted well well-sm no-shadow"> <?php echo e($data->problem_desc); ?></p>
        </div>
      </div><br>
