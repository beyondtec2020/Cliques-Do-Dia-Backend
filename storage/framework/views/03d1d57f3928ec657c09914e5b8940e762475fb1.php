        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navigation">
            <ul class="nav navbar-nav">
              ...
              <li class="menu-item-has-children"><a href="#">Category</a> <span class="arrow"></span>
                 <ul class="sub-menu">
            ...
            <li class="menu-item-has-children " style="">
                ...
                <li><a href="<?php echo e(url('/moderator')); ?>"> <i class="fa fa-home" style="font-size: 18px"></i> Dashboard</a></li>
                <?php elseif(Sentinel::check() && Sentinel::getUser()->roles()->first()->slug=='admin'): ?>
                <li><a href="<?php echo e(url('/admin')); ?>"> <i class="fa fa-home" style="font-size: 18px"></i> Dashboard</a></li>
                <?php elseif(Sentinel::check() && Sentinel::getUser()->roles()->first()->slug=='user'): ?>
                <li><a href="<?php echo e(url('/user')); ?>"> <i class="fa fa-home" style="font-size: 18px"></i> Dashboard</a></li>
                <?php endif; ?>
            ...
            <div class="submit_listing">
                <a href="<?php echo e(url('/add-lists-user')); ?>" class="btn outline-btn"><i class="fa  fa-plus-circle"></i> Submit Listing</a>
            </div>
