...
<section id="" class="section-padding">
	<div class="container">
    	<?php $catPosts = $category->addlists()->where('status',1)->paginate(11); ?>
    	<div class="row">
        <?php $__currentLoopData = $catPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        	<div class="col-md-3 grid_view show_listing">
                <div class="post_wrap">
                    <div class="text-center">
                        <h6><a href="<?php echo e(url('/single-post/'.$data->id.'/'.$data->slug)); ?>"><?php echo e(str_limit($data->title,18,'..')); ?></a></h6>
                    </div>
                    <div class="post_img">
                        ...
                        <div class="text-center selo">
                            <div class="selo-content">
                                <span class="selo-text"><?php echo e(round(100 - ($data->min_price * 100) / $data->max_price)); ?>%</span>
                            </div>
                        </div>
                    </div>
                    <div class="post_info">
                        <p style="margin-bottom: 0px"><?php echo e(str_limit($data->short_desc,30,'..')); ?></p>
