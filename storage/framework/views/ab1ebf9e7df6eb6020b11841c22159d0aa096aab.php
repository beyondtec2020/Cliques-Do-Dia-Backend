                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active in" id="tab_1_1">
                                ...
                                <form action="<?php echo e(route('saveAdd')); ?>" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane fade" id="tab_1_2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea name="val2" id="editor1" cols="30" rows="5" class="bold form-control input-lg" required placeholder="Advertise Code"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">STATUS</strong></label>
