    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
              <form action="<?php echo e(route('metakeyword')); ?>" method="post" class="form-horizontal">
    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
              <form action="<?php echo e(route('analytics')); ?>" method="post" class="form-horizontal">
              <?php echo e(csrf_field()); ?>
    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
              <form action="<?php echo e(route('fbcomment')); ?>" method="post" class="form-horizontal">
              <?php echo e(csrf_field()); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2  control-label">
                    Site name :</label>
                  <div class="col-sm-9">
                  <input type="text" name="siteurl" class="form-control" value="<?php echo e($seo->siteurl); ?>" placeholder="https://www.sitename.com/">
                  </div>
                </div>
            </div>
            <!-- /.box-body -->
