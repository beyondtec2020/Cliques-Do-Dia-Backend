            ...
            <div class="col-md-3 col-sm-6">
                <div class="timer-panel">
                    <div class="timer-panel-inner">
                        ...
                        <h1> <span class="counter"><?php echo $categoryCount; ?></span>+</h1>
                        <h6>CATEGORIES</h6>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="timer-panel">
                    <div class="timer-panel-inner">
                        ...
                        <h1> <span class="counter"><?php echo e($lising); ?> </span>+</h1>
                        <h6>LISTINGS</h6>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="timer-panel">
                    <div class="timer-panel-inner">
                        ...
                        <h1><?php echo e(Visitor::count()); ?></h1>
                        <h1><?php echo e(Visitor::log()); ?></h1>
                        <h6>VISITORS</h6>
                    </div>
                </div>
            </div>
