				...
				<div class="dashboard-list-box">
                    ...
                    <?php endif; ?>
                        <div class="buttons-to-right">
                            <a href="<?php echo e(route('editUserProfile')); ?>" class="button gray"><i class="fa fa-pencil"></i> Edit Profile</a>
                        </div>
                    </div>
                    <div class="user_info">
                    	<ul>
                        	<li><span>Name:</span> <?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></li>
                            <li><span>Email:</span> <?php echo e($user->email); ?></li>
                            <li><span>Phone:</span> <?php echo e($user->phone); ?></li>
                        </ul>
                    </div>
                </div>
			</div>
