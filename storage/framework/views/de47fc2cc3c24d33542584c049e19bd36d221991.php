      ...
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <div class="col-sm-9 col-sm-offset-2"><?php echo $__env->make('errors.errors', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div>
             ...
             <form action="<?php echo e(url('/update-category')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data" name="editCategoryForm">
            ...
            <input type="hidden" name="id" value="<?php echo e($category->id); ?>">
                ...
                <div class="form-group">
                  <label for="" class="col-sm-2  control-label">
                    Position :</label>
                  <div class="col-sm-9">
                  <input type="text" name="position"  id="position" class="form-control" placeholder=" menu position must be number" required autofocus pattern="\d*" min="0" value="<?php echo e($category->position); ?>">
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="col-sm-9 col-sm-offset-2">
              <button class="btn btn-lg btn-primary btn-block " type="submit">
                  <i class="fa fa-refresh"></i> <strong>  Update Category </strong>
              </button>
            </div>
            </div>
            </div>
      ...
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
             ...
             <form action="<?php echo e(url('/update-catImage')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
              <?php echo e(csrf_field()); ?>
            ...
            <input type="hidden" name="id" value="<?php echo e($category->id); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <br>
                    <img src="<?php echo e(asset('public/images/'.$category->cat_image)); ?>">
                  </div>
                </div>
            </div>
            <!-- /.box-body -->
            ...
            <div class="col-sm-9 col-sm-offset-2">
              <button class="btn btn-lg btn-primary btn-block " type="submit">
                  <i class="fa fa-refresh"></i> <strong>  Update Category Image </strong>
              </button>
            </div>
            </div>
            </div>
